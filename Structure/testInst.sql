...
EXEC [InstructorStp].stp_CreateExam
    ...
    @CourseInstanceId = 1, @BranchId = 1, @TrackId = 1, @IntakeId = 1,
    @Mode = 'Manual', @QuestionIds = '1,2,3 ,5,9,13,17,22,20,27';
GO
EXEC [InstructorStp].stp_CreateExam
    @ExamTitle = 'JavaScript&ES6', @ExamType = 'Regular',
...
select  
    ...
    @StartTime = '2026-06-03 09:00', @EndTime = '2026-06-03 11:00',
    @CourseInstanceId = 3, @BranchId = 1, @TrackId = 2, @IntakeId = 1,
    @Mode = 'Random', @questioncount =10 , @mcqcount=3 , @tfcount =5 , @textcount =2;
GO
EXEC [InstructorStp].stp_CreateExam
    @ExamTitle = 'SQL Final Exam', @ExamType = 'Regular',
    @StartTime = '2026-06-04 09:00', @EndTime = '2026-06-04 11:00',
    @CourseInstanceId = 4, @BranchId = 1, @TrackId = 2, @IntakeId = 1,
