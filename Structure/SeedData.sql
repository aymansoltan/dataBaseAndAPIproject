...
VALUES 
('Open Source', 1),        -- Smart Village
('Mobile Applications', 2), -- Nasr City
('Cloud Computing', 3),     -- Alexandria
('Cyber Security', 4),      -- Mansoura
('Data Science', 5);        -- Assiut
GO
...
VALUES 
-- Open Source Dept (DeptId: 1)
('Full Stack Web Development using PHP', 1),
('Python Development', 1),

-- Mobile Applications Dept (DeptId: 2)
('Cross Platform Mobile Development', 2),
('Android Development', 2),

-- Cloud Computing Dept (DeptId: 3)
('Azure Cloud Administration', 3),
('DevOps Engineering', 3),

-- Cyber Security Dept (DeptId: 4)
('Ethical Hacking', 4),
('Information Security', 4),

-- Data Science Dept (DeptId: 5)
('Data Analysis', 5),
('Machine Learning', 5);
GO
INSERT INTO [orgnization].IntakeTrack (IntakeId, TrackId)
VALUES 
-- Intake 44 (IntakeId: 1)
(1, 1), (1, 3), (1, 5), (1, 7), (1, 9),

-- Intake 45 (IntakeId: 2)
(2, 2), (2, 4), (2, 6), (2, 8), (2, 10),

-- Intake 46 (IntakeId: 3)
(3, 1), (3, 2), (3, 3), (3, 4), (3, 5);
GO
